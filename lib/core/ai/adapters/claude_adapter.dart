...
/// Skeleton for the Claude AI adapter.
class ClaudeAdapter implements AiProvider {
  final AiConfig config;

  ClaudeAdapter(this.config);

  @override
  Future<AiResponse> generateResponse(AiRequest request) async {
    throw UnimplementedError('Claude integration not yet fully implemented.');
  }

  @override
  Stream<String> streamResponse(AiRequest request) async* {
    throw UnimplementedError('Claude streaming not yet fully implemented.');
  }
