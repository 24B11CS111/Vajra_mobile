          ...
          children: [
            Expanded(
              child: PageView(
                ...
                physics: const NeverScrollableScrollPhysics(), // Force using the button
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Expanded(child: Center(child: content.animate().fadeIn(delay: 300.ms))),
        ],
      ),
    );
  }
      ...
      child: AnimatedContainer(
        ...
        child: Row(
          children: [
            ...
            Text(widget.title, style: TextStyle(color: selected ? VajraColors.primaryBackground : VajraColors.primaryText, fontWeight: FontWeight.w600)),
          ],
        ),
      ),
    );
